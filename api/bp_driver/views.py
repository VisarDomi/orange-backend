...
@bp.route("/<driver_id>/reservation/all", methods=["GET"])
@token_auth.login_required
...
@bp.route("/<driver_id>/reservation/<reservation_id>", methods=["GET"])
@token_auth.login_required
...
@bp.route("/<driver_id>/reservation/<reservation_id>", methods=["PUT"])
